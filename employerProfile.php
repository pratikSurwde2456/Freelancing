...
<div class="chatbot"  style="position:fixed; right:40px; bottom:100px; width:420px; transform: scale(0.5); opacity:0; pointer-events:none; overflow:hidden; background: #fff; border-radius:15px; box-shadow:0 0 128px 0 rgba(0,0,0,0.1), 0 32px 64px -48px rgba(0,0,0,0.5);" >
        <button class="chatbot-toggler">
			<span class="material-symbols-outlined">mode_comment</span>
			<span class="material-symbols-outlined">close</span>
		</button>
	<header style="background:#724ae8; padding:16px 0; text-align: center;">
		<h2 style= "color:#fff; font-size: 1.4rem;">Chatbot</h2>
    </header>
	<ul class="chatbot" style="height: 510px; overflow-y:auto; padding: 15px 20px 70px;">
	  <li class="chat incoming" style="display: flex;">
        <span class="material-symbols-outlined" style= "height:32px; width: 32px; color:#fff; align-self: flex-end; background: #724ae8; text-algin: center; line-height: 32px; border-radius: 4px">smart_toy</span>
	    <p style=" color: #000; font-size: 0.95rem; padding: 12px 16px; border-radius: 10px 10px 0 10px; background: #f2f2f2;">Hi there 👋 <br> How can I help you today ? </p>
	  </li>
	  <li class="chat outgoing" style="display: flex; margin:20px 0; justify-content:flex-end;">
	   <p style=" color: #fff; font-size: 0.95rem; padding: 12px 16px; border-radius: 10px 10px 0 10px; background: #724ae8;">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
	  </li>
    </ul>
	<div class="chat input" style=" position:absolute; bottom:0; width: 100%; display: flex; gap: 5px; background: #fff; padding: 5px 20px; border-top: 1px solid #ccc ">
		<textarea placeholder="Enter a message..."style="height: 55px; width: 100%; border: none; outline: none; font-size: 0.95rem; reize: none; padding: 16px 15px 16px 0;"  required ></textarea>
		<span id="send_btn " class="material-symbols-outlined" style="align-self: flex-end; height:55px; line-height:550x; color: #724ae8; font-size: 1.35rem; cursor:pointer; visibility:visible;">send</span>
