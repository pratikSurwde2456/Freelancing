...
<style>
	body{padding-top: 3%;margin: 0;background-image:url("image/img5");background-repeat:no-repeat;background-size:contain,cover;}
	.header1{background-color: #EEEEEE;padding-left: 1%;}
	.header2{padding:20px 40px 20px 40px;color:#fff;}
	.card{box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); background:#fff}
</style>
<script src="//code.tidio.co/9kcotukir5pybk6qso5bxf3noh4okyts.js" async></script>
